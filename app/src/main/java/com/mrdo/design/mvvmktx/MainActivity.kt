...
import com.mrdo.design.mvvmktx.utils.setImage
...
class MainActivity : BaseInjectAt<ActivityMainBinding, MainViewModel>() {
    ...
    override fun initData() {
        ...
        GlideUtils.setImage(this,iv_test,"https://ss0.bdstatic.com/94oJfD_bAAcT8t7mm9GUKT-xh_/timg?image&quality=100&size=b4000_4000&sec=1553689475&di=26cf068df37096567840d6e8cb00ea1a&src=http://pic.58pic.com/58pic/15/68/59/71X58PICNjx_1024.jpg")
    }
}
