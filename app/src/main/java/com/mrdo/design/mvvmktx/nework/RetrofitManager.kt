...
import com.mrdo.design.mvvmktx.constants.UrlConstant
import com.mrdo.design.mvvmktx.utils.NetworkUtil
import okhttp3.*
...
object RetrofitManager {
     ...
     */
    fun <T> getRetrofitService(baseUrl: String, cls: Class<T>): T {
...
//                .addHeader("","")
    ...
    private fun getRetrofit(url: String? = null): Retrofit {
        // 获取retrofit的实例
        return Retrofit.Builder()
            .baseUrl(url ?: UrlConstant.BASE_URL)  //自己配置
...
//            .cookieJar(addCookieJar())
     ...
     * 添加cookie
     */
    private fun addCookieJar(): CookieJar {
